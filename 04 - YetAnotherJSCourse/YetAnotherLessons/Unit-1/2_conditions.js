...
} else if (totalPrice <= 1350) {
    discountPercentage = totalPrice * 0.15;
} else if (totalPrice <= 2700) {
    discountPercentage = totalPrice * 0.30;
} else if (totalPrice <= 6500) {
    discountPercentage = totalPrice * 0.45;
} else {
    console.log('Invalid Price');
}
task7 = discountPercentage;
// enter your code here
...
if (x1 > 100) {
    task8 = "Greater than 100";
}
if (x1 <= 100) {
    task8 = "Less than or equal 100";
};
