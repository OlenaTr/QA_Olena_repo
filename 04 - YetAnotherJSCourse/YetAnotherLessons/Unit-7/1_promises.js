...
const promiseResolveFunc = () => {
    return new Promise((resolve) => {
        resolve("Resolved!");
    });
};
let promiseResolve = promiseResolveFunc;
...
// enter your code here
const promiseRejectFunc = () => {
    return new Promise((resolve, reject) => {
        reject("Rejected!");
    });
};
let promiseReject = promiseRejectFunc;
...
let fullPromise = fullPromiseFunc;
...
// enter your code here
const task4Func = () => {
    return promise1().then(result => result + ' was resolved successfully');
};
...
const task5Func = () => {
    return promise1().then(result1 => {
        return promise2().then(result2 => {
            return `${result1} and ${result2} - successfully resolved`;
        });
    });
};
