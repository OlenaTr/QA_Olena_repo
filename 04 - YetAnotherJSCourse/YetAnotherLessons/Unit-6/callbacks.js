 ...
 */
// enter your code below
const calculateSum = (numbers, someFuncWithParam) => {
    let sum = 0;
 ...
 */
// enter your code below
const countdown = function (duration , someFunc) {
 ...
 */
// enter your code below
const delayedGreeting = (name, someFuncWithParam) => {
    setTimeout(() => {
      const greeting = `Hello, ${name}!`;
      someFuncWithParam(greeting);
    }, 1000);
  };
...
// enter your code below
const greetWithDelay = (name, delay, someFuncWith2Params) => {
    setTimeout(() => {
      const message = 'Welcome to the callbacks.';
      someFuncWith2Params(name, message);
    }, delay * 1000);
  };
 ...
 */
// enter your code below
const countdown2 = (duration, someFunc) => {
    let count = duration;
    console.log(count);
    count--;
    if (count >= 0) {
        setTimeout(() => countdown2(count, someFunc), 1000);
    } else {
        someFunc();
    }
};
